...
CRG Systems 1.3.0 permits research and noncommercial use with attribution under
`LICENSE.md`. No separate commercial license is needed for those permitted
uses.

Without a separate written commercial license, you may use the software for:

- academic teaching and academic or public-interest research;
- personal study, experimentation, and other noncommercial purposes; and
...
- incorporation into, distribution with, or operation of a commercial product
  or service;
- internal operations that support revenue-generating activity; or
...
separately executed commercial agreement.
